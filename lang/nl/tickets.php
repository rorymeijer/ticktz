...
return [
    ...
    'actions' => [
        ...
        'assign' => 'Toewijzen',
        'clone' => 'Kopiëren',
        'clone_title' => 'Dit verzoek opnieuw indienen',
        'clone_help' => 'Neemt de omschrijving, de melder, de labels en de antwoorden op dit formulier over. Het gesprek, de bijlagen en de toewijzing blijven bij het origineel, en de twee worden aan elkaar gekoppeld.',
        'clone_type' => 'Indienen als',
        'clone_same_type' => 'Hetzelfde soort verzoek',
        'clone_submit' => 'Kopie aanmaken',
    ...
    'flash' => [
        ...
        'cloned' => 'Ingediend als kopie van :key.',
    ...
    'errors' => [
        ...
        'assignee_not_permitted' => 'Je hebt geen rechten om tickets toe te wijzen.',
