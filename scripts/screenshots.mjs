...
const SHOTS = [
    ...
    { slug: '1g-admin-updates', path: '/admin/updates?lang=en', as: 'admin', fullPage: true },
    ...
    { slug: '20-agent-dashboard', path: '/dashboard?lang=en', as: 'agent', fullPage: true },
    ...
    { slug: '80-reports-sla', path: '/reports?report=sla&from=2026-08-17&lang=en', as: 'admin', fullPage: true },
    { slug: '81-reports-sla-queue', path: '/reports?report=sla&from=2026-08-17&dimension=queue&lang=en', as: 'admin', fullPage: true },
    { slug: '82-reports-volume', path: '/reports?report=volume&from=2026-08-17&lang=en', as: 'admin', fullPage: true },
